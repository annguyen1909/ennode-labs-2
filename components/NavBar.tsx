...
export default function NavBar() {
  return (
    <nav className="fixed top-4 left-1/2 transform -translate-x-1/2 z-50 w-[92%] max-w-5xl">
      <div className="backdrop-blur-md bg-black/10 border border-white/6 rounded-xl px-4 py-2 flex items-center justify-between shadow-lg">
        ...
        <div className="flex items-center gap-4">
          ...
          <Link href="/work" className="text-sm text-white/90 hover:text-white transition" onMouseEnter={(e) => gsap.to(e.currentTarget as HTMLElement, { scale: 1.06, duration: 0.14 })} onMouseLeave={(e) => gsap.to(e.currentTarget as HTMLElement, { scale: 1, duration: 0.14 })}>WORK</Link>
